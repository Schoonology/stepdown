 ...
 * all functions passed to the new function will be passed as non-Error
...
function createContext(callback, next) {
  ...
  function context(name) {
    ...
    function callback(err, data) {
      ...
      debug('Satisfied callback for %j with %j', name, data)
 ...
 *
 * More interestingly, this function one major side effect: it calls (or
...
/*!
 * Expose the internals for advanced users.
 */
