...
function _initAsyncProps() {
    ...
    self._initAsyncProp('push', function push(type, hookFn) {
        return self.results.alloc(type, hookFn);
    });
    self._initAsyncProp('first', function first(hookFn) {
        return self.results.alloc('first', hookFn);
    });
    self._initAsyncProp('collapse', function collapse(hookFn) {
        return self.results.alloc('collapse', hookFn);
    });
    self._initAsyncProp('spread', function spread(hookFn) {
        return self.results.alloc('spread', hookFn);
    });
    self._initAsyncProp('event', function event(hookFn) {
